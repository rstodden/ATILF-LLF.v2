    ...
    for mod in 500; do
        ...
        for dir in ../sharedtask_11/**; do
            ...
            for svm in 0; do
                ...
                python ../Src/identifier.py --svm 0 --cnn 1 --epoches 10 --number_modulo mod --nrrun $nrrun --predictonly $prediction --descriptionPath $descr --useBatchGenerator 0 $language".json" "a" "b"
                if [ $cnn = 1 ] && [ $svm = 1 ]; then
                    echo $svm $cnn
                    ...
                    if [ $language = "EN" ] || [ $language = "HI" ] || [ $language = "LT" ]; then
                        ...
                        ../11/bin/evaluate.py --gold ../Results/MWEFiles/testSet/$mod/CNN-SVM/$language/$language.gold.txt --pred ../Results/MWEFiles/testSet/$mod/CNN-SVM/$language/test.system.cupt  >> ../Results/MWEFiles/testSet/$mod/CNN-SVM/$language"_epo"$epoches"_mod"$mod"_"$i.eval.txt
                    else
                        ...
                        ../11/bin/evaluate.py --gold ../sharedtask_11/$language/dev.cupt --pred ../Results/MWEFiles/testSet/$mod/CNN-SVM/$language/test.system.cupt  >> ../Results/MWEFiles/testSet/$mod/CNN-SVM/$language"_epo"$epoches"_mod"$mod"_"$i.eval.txt
                    fi
                else
                    ...
                    if [ $language = "EN" ] || [ $language = "HI" ] || [ $language = "LT" ]; then
                        ...
                        ../11/bin/evaluate.py --gold ../Results/MWEFiles/testSet/$mod/CNN/$language/$language.gold.txt --pred ../Results/MWEFiles/testSet/$mod/CNN/$language/test.system.cupt >> ../Results/MWEFiles/testSet/$mod/CNN/$language"_epo"$epoches"_mod"$mod"_"$i.eval.txt
                    else
                        ../11/bin/evaluate.py --gold ../sharedtask_11/$language/dev.cupt --pred ../Results/MWEFiles/testSet/$mod/CNN/$language/test.system.cupt
                        ../11/bin/evaluate.py --gold ../sharedtask_11/$language/dev.cupt --pred ../Results/MWEFiles/testSet/$mod/CNN/$language/test.system.cupt  >> ../Results/MWEFiles/testSet/$mod/CNN/$language"_epo"$epoches"_mod"$mod"_"$i.eval.txt
                    fi
